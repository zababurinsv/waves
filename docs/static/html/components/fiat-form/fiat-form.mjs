      ...
      constructor () {
        ...
        async function modules (obj) {
          ...
          script.onload = function() {
            ...
            const expirationdate = obj['this'].shadowRoot.querySelector('#expirationdate');
            const securitycode = obj['this'].shadowRoot.querySelector('#securitycode');
...
//On Input Change Events
            ...
            expirationdate_mask.on('accept', function () {
              if (expirationdate_mask.value.length == 0) {
                obj['this'].shadowRoot.getElementById('svgexpire').innerHTML = '01/23';
              } else {
                obj['this'].shadowRoot.getElementById('svgexpire').innerHTML = expirationdate_mask.value;
              }
            });
